...
5. Run [InfGCN](https://github.com/amelie-iska/InfGCN-DFT) (se also [the original public versionon](https://github.com/ccr-cheng/InfGCN-pytorch)) the trajectories to obtain fine-grained electron densities evolving over time according to the Boltzmann distribution for the peptide based QPU scaffold  
